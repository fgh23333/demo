<template>
  <div class="wrapper">
    ...
    <div class="cart">
      <div class="cart-left">
        <!--购物车中没有商品，则显示灰色图标 -->
        <div class="cart-left-icon" :style="totalQuantity > 0 ? 'background-color:#fb8b06' : 'background-color:#cecece'">
      ...
      <div class="cart-right">
        <!-- 不够起送费显示内容  -->
        <div v-if="totalPrice < business.starPrice" class="cart-right-item" :style="'background-color:#CECECE;'">
          &#165;{{ business.starPrice }}起送
        </div>

        <!-- 达到起送费显示内容 v-show="totalSettle>=business.starPrice"-->
        <div v-else class="cart-right-item">
          去结算
        </div>
      </div>
    </div>
